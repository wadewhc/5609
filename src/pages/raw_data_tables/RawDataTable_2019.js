...
const allRows = [
  createData('Handguns', 6665),
  createData('Firearms, type not stated', 3417),
  createData('Knives or cutting instruments', 1555),
  createData('Other weapons or weapons not stated', 927),
  createData('Personal weapons (hands/fists/feet/etc.)', 656),
  createData('Blunt objects (clubs/hammers/etc.)', 420),
  createData('Rifles', 377),
  createData('Shotgun', 215),
  createData('Narcotics', 117),
  createData('Asphyxiation', 95),
  createData('Fire', 87),
  createData('Strangulation', 67),
  createData('Other guns', 51),
  createData('Poison', 17),
  createData('Drowning', 7),
  createData('Explosives', 2),
];

function RawDataTable2019() {
  ...
  return (
    <TableContainer  sx={{ width: "83.6vw" }} className="raw_data_table" component={Paper}>
      <Table aria-label="simple table">
        <TableHead>
          <TableRow>
            <TableCell sx={{ backgroundColor: "black", color: "white" }}>Weapon Category 2019</TableCell>
...
export default RawDataTable2019;