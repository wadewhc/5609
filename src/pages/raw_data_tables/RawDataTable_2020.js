...
const allRows = [
  createData('Handguns', 8633),
  createData('Firearms, type not stated', 5048),
  createData('Knives or cutting instruments', 1818),
  createData('Other weapons or weapons not stated', 1054),
  createData('Personal weapons (hands/fists/feet/etc.)', 725),
  createData('Rifles', 493),
  createData('Blunt objects (clubs/hammers/etc.)', 421),
  createData('Shotgun', 214),
  createData('Narcotics', 168),
  createData('Fire', 114),
  createData('Other guns', 113),
  createData('Asphyxiation', 78),
  createData('Strangulation', 58),
  createData('Poison', 17),
  createData('Drowning', 5),
  createData('Explosives', 3),
];

function RawDataTable2020() {
  ...
  return (
    <TableContainer  sx={{ width: "80.5vw" }} className="raw_data_table" component={Paper}>
      <Table aria-label="simple table">
        <TableHead>
          <TableRow>
            <TableCell sx={{ backgroundColor: "black", color: "white" }}>Weapon Category 2020</TableCell>
...
export default RawDataTable2020;