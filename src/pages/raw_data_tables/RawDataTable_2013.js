...
const allRows = [
  createData('Handguns', 5488),
  createData('Firearms, type not stated', 1815),
  createData('Other weapons or weapons not stated', 1604),
  createData('Knives or cutting instruments', 1434),
  createData('Personal weapons (hands/fists/feet/etc.)', 701),
  createData('Blunt objects (clubs/hammers/etc.)', 419),
  createData('Shotgun', 275),
  createData('Rifles', 239),
  createData('Other guns', 116),
  createData('Asphyxiation', 88),
  createData('Strangulation', 82),
  createData('Fire', 76),
  createData('Narcotics', 55),
  createData('Poison', 13),
  ...
  return (
    <TableContainer  sx={{ width: "80.5vw" }} className="raw_data_table" component={Paper}>
      <Table aria-label="simple table">
        <TableHead>
          <TableRow>
            <TableCell sx={{ backgroundColor: "black", color: "white" }}>Weapon Category 2013</TableCell>
...
export default RawDataTable2013;