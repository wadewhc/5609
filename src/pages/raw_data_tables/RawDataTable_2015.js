...
const allRows = [
  createData('Handguns', 6175),
  createData('Firearms, type not stated', 2315),
  createData('Other weapons or weapons not stated', 1714),
  createData('Knives or cutting instruments', 1526),
  createData('Personal weapons (hands/fists/feet/etc.)', 647),
  createData('Blunt objects (clubs/hammers/etc.)', 436),
  createData('Shotgun', 247),
  createData('Rifles', 216),
  createData('Other guns', 151),
  createData('Asphyxiation', 105),
  createData('Strangulation', 97),
  createData('Narcotics', 69),
  createData('Fire', 63),
  ...
  return (
    <TableContainer  sx={{ width: "80.5vw" }} className="raw_data_table" component={Paper}>
      <Table aria-label="simple table">
        <TableHead>
          <TableRow>
            <TableCell sx={{ backgroundColor: "black", color: "white" }}>Weapon Category 2015</TableCell>
...
export default RawDataTable2015;