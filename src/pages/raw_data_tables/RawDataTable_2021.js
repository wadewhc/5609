...
const allRows = [
  createData('Handguns', 6556),
  createData('Firearms, type not stated', 5345),
  createData('Other weapons or weapons not stated', 1223),
  createData('Knives or cutting instruments', 1202),
  createData('Personal weapons (hands/fists/feet/etc.)', 555),
  createData('Rifles', 462),
  createData('Other guns', 296),
  createData('Blunt objects (clubs/hammers/etc.)', 280),
  createData('Shotgun', 170),
  createData('Narcotics', 160),
  createData('Fire', 88),
  createData('Asphyxiation', 63),
  createData('Poison', 9),
  createData('Strangulation', 3),
  createData('Explosives', 1),
  createData('Drowning', 0),
];

function RawDataTable2021() {
  ...
  return (
    <TableContainer  sx={{ width: "83.6vw" }} className="raw_data_table" component={Paper}>
      <Table aria-label="simple table">
        <TableHead>
          <TableRow>
            <TableCell sx={{ backgroundColor: "black", color: "white" }}>Weapon Category 2021</TableCell>
...
export default RawDataTable2021;